...
It now proves hosted identity fetch, channel read-back, direct `fetchMessage(...)`, an edit-plus-refetch cycle, and typed delete confirmation on the confirmed probe.
